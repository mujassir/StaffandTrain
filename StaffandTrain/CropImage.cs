...
namespace StaffandTrain
{
    public class CropImage
    {
        public static class Imager
        {
            ...
            public static void PerformImageResizeAndPutOnCanvas(string pFilePath, string CropImagePath, string pFileName, int pWidth, int pHeight, string pOutputFileName)
            {
                ...
                //Save JPEG ;
                Imager.SaveJpeg(CropImagePath + pOutputFileName, _img2);
